    ...
    widgetCssTemplate: function(widget){
      ...
      */
      ...
      if ( window.sincloInfo.contract.chat ) {
        ...
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label { position: relative; display: flex; width: 100%; cursor: pointer; margin 0; color:' + colorList['reTextColor'] + '; min-height: 12px; font-size: ' + widget.reTextSize + 'px; line-height: ' + ((Number(widget.reTextSize)+2) * 1.4) + 'px; } ';
