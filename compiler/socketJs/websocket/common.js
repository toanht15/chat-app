    ...
    widgetCssTemplate: function(widget){
      ...
      */
      ...
      if ( window.sincloInfo.contract.chat ) {
        ...
        html += '#sincloBox #chatTalk li.sinclo_se div.receiveFileContent div.selectFileArea p.commentarea { text-align: center; width: 100%; margin-bottom: 3px; font-size: 0px; }';
