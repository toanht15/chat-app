          ...
          if(Number(widget.closeButtonSetting) === 2 && Number(widget.closeButtonModeType) === 1){
            ...
            if(typeof(widget.spBannerVerticalPositionFromBottom) === "string" && widget.spBannerVerticalPositionFromBottom.indexOf("px") !== -1){
              ...
              case 3://右中央
                ...
                html += '      #sincloBox div#sincloBannerBox div#sincloBanner.sincloBanner .bannertext {line-height:' + (10 * ratio + 1) + 'px; margin-left: 0px; margin-right: 0; color: '+ widget.stringColor +'; font-size: '+ (10 * ratio) +'px; vertical-align: middle; -webkit-writing-mode: vertical-rl; -ms-writing-mode: tb-rl; writing-mode: vertical-rl; letter-spacing: 1px;}';
              ...
              case 4://左中央
                ...
                html += '      #sincloBox div#sincloBannerBox div#sincloBanner.sincloBanner .bannertext {line-height:' + (10 * ratio + 1) + 'px; margin-right: 0px; margin-left: 0; color: '+ widget.stringColor +'; font-size: '+ (10 * ratio) +'px; vertical-align: middle; -webkit-writing-mode: vertical-rl; -ms-writing-mode: tb-rl; writing-mode: vertical-rl; letter-spacing: 1px;}';
                html += '      #sincloBox div#sincloBannerBox #sincloBanner .sincloBannerText{ flex-flow: column nowrap; margin: '+ Math.ceil(10 * ratio) + 'px '+ Math.ceil(5 * ratio) +'px; }';
                html += '      #sincloBox div#sincloBannerBox div#sincloBanner div#sincloBannerText #bannerIcon { width: ' + Math.ceil(10 * ratio) + 'px; height: ' + Math.ceil(10 * ratio) + 'px; opacity: 1; margin-bottom: 5px; }';
                break;
              default://右下
