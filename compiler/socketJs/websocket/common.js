          ...
          if(Number(widget.closeButtonSetting) === 2 && Number(widget.closeButtonModeType) === 1){
            ...
            if(typeof(widget.spBannerVerticalPositionFromBottom) === "string" && widget.spBannerVerticalPositionFromBottom.indexOf("px") !== -1){
              ...
              case 3://右中央
                ...
                html += '      #sincloBox div#sincloBannerBox div#sincloBanner.sincloBanner .bannertext {width: '+ (13 * ratio) + 'px; margin-right: 0px; margin-left: 0; color: '+ widget.stringColor +'; font-size: '+ (10 * ratio) +'px; letter-spacing: 1px;}';
                html += '      #sincloBox div#sincloBannerBox #sincloBanner .sincloBannerText{height: auto; margin: '+ Math.ceil(10 * ratio) + 'px '+ Math.ceil(8.5 * ratio) +'px; -webkit-writing-mode: vertical-rl; -ms-writing-mode: vertical-rl; writing-mode: vertical-rl;}';
                html += '      #sincloBox div#sincloBannerBox div#sincloBanner div#sincloBannerText #bannerIcon { width: ' + (13 * ratio) + 'px; height: ' + Math.ceil(10 * ratio) + 'px; opacity: 1; margin:0 0 5px 0; }';
                break;
              case 4://左中央
