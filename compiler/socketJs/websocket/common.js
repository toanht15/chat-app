...
//      var widget = window.sincloInfo.widget;
    ...
    widgetCssTemplate: function(widget){
      ...
      switch ( Number(widget.chatMessageDesignType) ) {
        case 1: //BOX型
          chatPosition.se = "margin-left: 31px; margin-right: 10px;  border-bottom-right-radius: 0;";
          chatPosition.re = "margin-left: 10px; margin-right: 31px; border-bottom-left-radius: 0;";
          break;
        case 2: //吹き出し型
          // 何もしない
          break;
