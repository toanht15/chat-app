...
//      var widget = window.sincloInfo.widget;
    ...
    widgetCssTemplate: function(widget){
      ...
      */
      ...
      html += '      #sincloBox span#mainImage i {display: flex; justify-content: center; align-items: center; width: 62px; height: 70px; font-size: 43px; border: 1px solid; }';
      ...
      html += '      #sincloBox p#widgetTitle { position:relative; cursor:pointer; border: 1px solid ' + colorList['mainColor'] + '; border-bottom:none; background-color: ' + colorList['mainColor'] + ';text-align: center; margin: 0; color: ' + colorList['stringColor'] + ' }';
      ...
      if ( window.sincloInfo.contract.chat ) {
        ...
        if (widget.chatMessageWithAnimation === 1) {
          html += '      #sincloBox ul#chatTalk li.effect_right { -webkit-animation-name:rightEffect; -moz-animation-name:rightEffect; -o-animation-name:rightEffect; -ms-animation-name:rightEffect; animation-name:rightEffect; -webkit-animation-duration:0.5s; -moz-animation-duration:0.5s; -o-animation-duration:0.5s; -ms-animation-duration:3s; animation-duration:0.5s; -webkit-animation-iteration-count:1; -moz-animation-iteration-count:1; -o-animation-iteration-count:1; -ms-animation-iteration-count:1; animation-iteration-count:1; -webkit-animation-fill-mode:both; -moz-animation-fill-mode:both; -o-animation-fill-mode:both; -ms-animation-fill-mode:both; animation-fill-mode:both; -webkit-transform-origin:left bottom; -moz-transform-origin:left bottom; -o-transform-origin:left bottom; -ms-transform-origin:left bottom; transform-origin:left bottom; opacity:0; -webkit-animation-delay:0.6s; -moz-animation-delay:0.6s; -o-animation-delay:0.6s; -ms-animation-delay:0.6s; animation-delay:0.6s; }';
        ...
        html += '      #sincloBox ul#chatTalk li sinclo-radio { display: inline-block; } ';
        ...
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label { position: relative; display: inline-flex; width: 100%; cursor: pointer; margin 0; color:' + colorList['reTextColor'] + '; min-height: 12px; font-size: ' + widget.reTextSize + 'px; line-height: ' + ((Number(widget.reTextSize)+2) * 1.4) + 'px; } ';
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label p { display:table-cell; font-size: ' + widget.reTextSize + 'px; vertical-align: middle; margin-left: 5px; line-height: ' + ((Number(widget.reTextSize)+2) * 1.4) + 'px; } ';
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label:before { content: ""; vertical-align: middle; display: flex; flex: 0 0 auto; align-self: flex-start; margin-top: ' + (Number(widget.reTextSize)+1) * (1.4 - 1) / 2 + 'px; width: ' + (Number(widget.reTextSize)+1) + 'px; height: ' + (Number(widget.reTextSize)+1) + 'px; border: 0.5px solid #999; border-radius: 50%; background-color: #FFF; } ';
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"]:checked + label:after { content: ""; display: flex; align-self: flex-start; position: absolute; margin-top: ' + (Number(widget.reTextSize)+1) * (1.4 - 1) / 2 + 'px; left: ' + ((widget.reTextSize/2 - ((widget.reTextSize-6)/2))+1) + 'px; top: ' + ((widget.reTextSize/2 - ((widget.reTextSize-6)/2))+1) + 'px; width: ' + (Number(widget.reTextSize)-6) + 'px; height: ' + (Number(widget.reTextSize)-6) + 'px; background: ' + colorList['mainColor'] + '; border-radius: 50%; } ';
        ...
        if(Number(widget.widgetSizeType) == 1) {
          ...
          html += '#sincloBox #chatTalk li.sinclo_se.uploaded { padding: 10px!important; line-height: 0; }';
          html += '#sincloBox #chatTalk li.sinclo_re div.receiveFileContent div.selectFileArea p.drop-area-message { margin: 9px 0 6.5px; line-height: 20px; }';
          html += '#sincloBox #chatTalk li.sinclo_re div.receiveFileContent div.selectFileArea p.drop-area-button { display: flex; justify-content: center; line-height: 0px; margin: 6.5px 0 9px; }';
          ...
          html += '#sincloBox #chatTalk li.sinclo_se.uploaded { padding: 12px!important; line-height: 0; }';
          ...
          html += '#sincloBox #chatTalk li.sinclo_se.uploaded { padding: 14px!important; line-height: 0; }';
          html += '#sincloBox #chatTalk li.sinclo_re div.receiveFileContent div.selectFileArea p.drop-area-message { margin: 13px 0 6.5px; line-height: 24px; }';
          html += '#sincloBox #chatTalk li.sinclo_re div.receiveFileContent div.selectFileArea p.drop-area-button { display: flex; justify-content: center; line-height: 0px; margin: 6.5px 0 13px; }';
        }
        ...
        html += '#sincloBox #chatTalk li.sinclo_se div.receiveFileContent div.selectFileArea p.commentarea textarea { display: block; margin: 0 auto; border-radius: 0px; width: 97%; height: 40px; resize: none; }';
        ...
        html += '#sincloBox #chatTalk li.sinclo_se div.receiveFileContent div.actionButtonWrap { display: flex; justify-content: space-between; width: 97%; margin: 0 auto; font-size: 0px; }';
        ...
        html += '      #sincloBox section#chatTab sinclo-div #sincloChatSendBtn, #sincloBox section#chatTab sinclo-div #miniSincloChatSendBtn { display: block; height: 100%; width: 20%; text-decoration: none; border-radius: 0 5px 5px 0; cursor: pointer; margin: 0; text-align: center; background-color: ' + colorList['chatSendBtnBackgroundColor'] + '; color: ' + colorList['chatSendBtnTextColor'] + '; font-weight: bold; font-size: 1.2em;}';
...
*/
          ...
          if(widget.spMaximizeSizeType === 2) {
            html += '#sincloBox ul#chatTalk { padding: ' + (5 * ratio) + 'px; padding-top:0px; padding-bottom: ' + (60 * ratio) + 'px; height: ' + (194 * ratio) + 'px; background-color: '+ colorList['chatTalkBackgroundColor'] +' }';
          } else {
            html += '#sincloBox ul#chatTalk { padding: ' + (5 * ratio) + 'px; padding-top:0px; padding-bottom: ' + (60 * ratio) + 'px; height: ' + (194 * ratio) + 'px; background-color: '+ colorList['chatTalkBackgroundColor'] +' }';
          }
          ...
          html += '#sincloBox ul#chatTalk li sinclo-radio * { -webkit-transform: scale(' + (1 * ratio) + '); -webkit-transform-origin: left top;  transform: scale(' + (1 * ratio) + '); transform-origin: left top; -moz-transform: scale(' + (1 * ratio) + '); -mox-transform-origin: left top; } ';
          ...
          if(Number(widget.closeButtonSetting) === 2 && Number(widget.closeButtonModeType) === 1){
            ...
            html += '      #sincloBox div#sincloBannerBox div#sincloBanner #bannerIcon { width: ' + Math.ceil(24 * ratio) + 'px; height: ' + Math.ceil(24 * ratio) + 'px; opacity: 1; margin: 0px ' + (5 * ratio) + 'px; }';
            html += '      #sincloBox div#sincloBannerBox div#sincloBanner.sincloBanner .bannertext{ color: '+ widget.stringColor +'; font-size: '+ (12.5 * ratio) +'px; vertical-align: middle; margin-right: ' + (5 * ratio) + 'px; }';
...
*/
          ...
          html += '#sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label:before { content: ""; display: block; position: absolute; top: 10px; margin-top: -10px; left: 0px; width: 20px; height: 20px; border: 0.5px solid ' + chatContentTextColor + '; border-radius: 50%; } ';
          html += '#sincloBox ul#chatTalk li sinclo-radio [type="radio"]:checked + label:after { content: ""; display: block; position: absolute; top: 10px; left: 5px; margin-top: -5px; width: 11px; height: 11px; background: ' + colorList['mainColor'] + '; border-radius: 50%; } ';
          ...
          if(Number(widget.closeButtonSetting) === 2 && Number(widget.closeButtonModeType) === 1){
            ...
            html += '      #sincloBox div#sincloBannerBox #sincloBanner #bannerIcon { width: ' + Math.ceil(24 * ratio) + 'px; height: ' + Math.ceil(24 * ratio) + 'px; opacity: 1; margin: 0px ' + (5 * ratio) + 'px; }';
            html += '      #sincloBox div#sincloBannerBox #sincloBanner.sincloBanner .bannertext{ color: '+ widget.stringColor +'; font-size: '+ (12.5 * ratio) +'px; padding: 0 '+ (10 * ratio) +'px 0 '+ (3 * ratio) +'px; }';
            html += '      #sincloBox div#sincloBannerBox #sincloBanner.sincloBanner .notext{ cursor: pointer; }';
          }
        }
      }
...
//        html += "      #sincloBox section#navigation ul { width: " + widgetWidth + "px }";
        ...
        html += '      #sincloBox p#widgetTitle { border-radius: ' + widget.radiusRatio + 'px ' + widget.radiusRatio + 'px 0 0; font-size: '+ widget.headerTextSize +'px; padding: 7px 0px 7px 0px !important; height: auto; line-height: ' + widget.headerTextSize + 'px;}';
...
//      }
      ...
      if ( !chatAndTitleOnly && (Number(widget.showMainImage) === 1 || widget.mainImage !== "") ) {
        ...
        if(widget.mainImage.match(/^fa/) !== null) {
          html += '    <i class="sinclo-fal ' + widget.mainImage + '" style="width:' + (ratio * 62) + 'px!important; height:' + (ratio * 70) + 'px!important;" alt="チャット画像"></i>';
        } else {
