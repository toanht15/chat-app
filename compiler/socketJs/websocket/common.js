    ...
    widgetCssTemplate: function(widget){
      ...
      */
      ...
      if ( window.sincloInfo.contract.chat ) {
        ...
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label:before { content: ""; display: block; position: absolute; top: ' + Math.ceil((Number(widget.reTextSize)/2)) + 'px; left: 0px; margin-top: -' + Math.ceil((Number(widget.reTextSize)/2)) + 'px; width: ' + (Number(widget.reTextSize)+1) + 'px; height: ' + (Number(widget.reTextSize)+1) + 'px; border: 0.5px solid #999; border-radius: 50%; background-color: #FFF; } ';
...
*/
          ...
          html += '#sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label:before { content: ""; display: block; position: absolute; top: ' + (11 * ratio)/2 + 'px; margin-top: -' + (11 * ratio)/2 + 'px; left: '+ (0 * ratio) +'px; width: '+ (12 * ratio) +'px; height: '+ (12 * ratio) +'px; border: 0.5px solid ' + chatContentTextColor + '; border-radius: 50%; background-color: #FFF; } ';
...
*/
          ...
          html += '#sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label:before { content: ""; display: block; position: absolute; top: 10px; margin-top: -10px; left: 0px; width: 21px; height: 21px; border: 0.5px solid ' + chatContentTextColor + '; border-radius: 50%; } ';
