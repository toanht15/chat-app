...
//      var widget = window.sincloInfo.widget;
      ...
      switch (sizeTypeID) {
        case 1: //小
          var sizeArray = {
            ...
            widgetTitleTop: 6,
            widgetSubTitleHeight: 27,
            widgetDescriptionHeight: 25,
            navigationHeight: 40,
            chatTalkHeight: 194,
    ...
    widgetCssTemplate: function(widget){
      ...
      //アイコンフォント用
      html += '      #sincloBox div, #sincloBox span, #sincloBox applet, #sincloBox object, #sincloBox iframe, #sincloBox h1, #sincloBox h2, #sincloBox h3, #sincloBox h4, #sincloBox h5, #sincloBox h6, #sincloBox p, #sincloBox blockquote, #sincloBox pre, #sincloBox a, #sincloBox abbr, #sincloBox acronym, #sincloBox address, #sincloBox big, #sincloBox cite, #sincloBox code, #sincloBox del, #sincloBox dfn, #sincloBox em, #sincloBox font, #sincloBox ins, #sincloBox kbd, #sincloBox q, #sincloBox s, #sincloBox samp, #sincloBox small, #sincloBox strike, #sincloBox strong, #sincloBox sub, #sincloBox sup, #sincloBox tt, #sincloBox var, #sincloBox dl, #sincloBox dt, #sincloBox dd, #sincloBox ol, #sincloBox ul, #sincloBox li, #sincloBox fieldset, #sincloBox form, #sincloBox label, #sincloBox legend, #sincloBox table, #sincloBox caption, #sincloBox tbody, #sincloBox tfoot, #sincloBox thead, #sincloBox tr, #sincloBox th, #sincloBox td, #sincloBox input, #sincloBox textarea { font-family: "Hiragino Kaku Gothic ProN","メイリオ",Helvetica,Arial,sans-serif; font-size: 14px; text-align: left; -webkit-font-smoothing: subpixel-antialiased;font-weight: normal;text-indent: 0;text-align: start;letter-spacing: normal;line-height: normal;text-decoration: none;margin: 0;padding: 0;float: none;direction: normal;width: auto;max-width: none;min-width: 0;height: auto;max-height: none;min-height: 0;word-spacing: normal;vertical-align: baseline;background: transparent;top: unset;left: unset;right: unset;bottom: unset;border: none;box-shadow: none;text-shadow: none;position: static;}';
      ...
      if ( window.sincloInfo.contract.chat ) {
        ...
        if (widget.chatMessageDesignType === 2) {
          // 吹き出し型
          html += '      #sincloBox ul#chatTalk li { line-height: 1.4; padding: 10px 15px !important; border-radius: 12px !important;}';
        ...
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label { position: relative; display: inline-block; width: 100%; cursor: pointer; padding: 0 0 0 ' + (Number(widget.reTextSize) + 7) + 'px; color:' + colorList['reTextColor'] + '; min-height: 12px; font-size: ' + widget.reTextSize + 'px; } ';
...
*/
          ...
          html += '#sincloBox ul#chatTalk li { border-radius: ' + (5 * ratio) + 'px; margin: ' + (5 * ratio) + 'px 0; padding: ' + (10 * ratio) + 'px ' + (15 * ratio) + 'px; font-size: ' + (12 * ratio) + 'px; }';
          html += '#sincloBox ul#chatTalk li.sinclo_se { font-size: ' + (12 * ratio) + 'px; }';
          html += '#sincloBox ul#chatTalk li.sinclo_re { font-size: ' + (12 * ratio) + 'px; }';
...
*/
          ...
          html += '#sincloBox ul#chatTalk li div.sendFileThumbnailArea { display: table-cell; width: ' + (64 * ratio) + 'px; height: ' + (64 * ratio) + 'px; border: 1px solid #D9D9D9; }';
          html += '#sincloBox ul#chatTalk li.sinclo_se { font-size: 0.8em; }';
          html += '#sincloBox ul#chatTalk li.sinclo_re { font-size: 0.8em; }';
          if(colorList['seBorderNone'] === 0){
            html += '#sincloBox ul#chatTalk li.sinclo_se { border: ' + (1 * ratio) + 'px solid '+ colorList['seBorderColor'] +'; }';
          }
          if(colorList['reBorderNone'] === 0){
...
//        html += "      #sincloBox section#navigation ul { width: " + widgetWidth + "px }";
        ...
        html += '      #sincloBox p#widgetTitle { border-radius: ' + widget.radiusRatio + 'px ' + widget.radiusRatio + 'px 0 0; border: 1px solid ' + colorList['mainColor'] + '; font-size: '+ widget.headerTextSize +'px; padding: 8px 30px 8px 30px; height: auto; line-height: ' + widget.headerTextSize + 'px;}';
        ...
        html += '      #sincloBox p#widgetSubTitle { background-color: '+ colorList['headerBackgroundColor'] +'; margin: 0; text-align: left; border-width: 0 1px 0 1px; padding-top: 3px; border-color: '+ colorList['widgetBorderColor'] +'; border-style: solid; padding-left: 77px; font-weight: bold; color: ' + colorList['subTitleTextColor'] + '; height: '+ sizeList['widgetSubTitleHeight'] +'px; line-height: ' + sizeList['widgetSubTitleHeight'] + 'px; font-size: ' + (Number(widget.headerTextSize) - 2) + 'px; }';
        if(colorList['widgetBorderNone'] === 1){
          html += '#sincloBox p#widgetSubTitle { border:none; }';
        }
