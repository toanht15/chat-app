...
//      var widget = window.sincloInfo.widget;
    ...
    widgetCssTemplate: function(widget){
      ...
      if ( window.sincloInfo.contract.chat ) {
        ...
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"] + label:before { content: ""; display: block; position: absolute; top: 50%; left: 0px; margin-top: -' + (Number(widget.reTextSize)/2) + 'px; width: ' + Number(widget.reTextSize) + 'px; height: ' + Number(widget.reTextSize) + 'px; border: 1px solid #999; border-radius: 50%; background-color: #FFF; } ';
        html += '      #sincloBox ul#chatTalk li sinclo-radio [type="radio"]:checked + label:after { content: ""; display: block; position: absolute; top: 50%; left: ' + (Number(widget.reTextSize)/4) + 'px; margin-top: ' + (Number(widget.reTextSize)/4) + 'px; width: ' + (Number(widget.reTextSize)/2 + 1) + 'px; height: ' + (Number(widget.reTextSize)/2 + 1) + 'px; background: ' + colorList['mainColor'] + '; border-radius: 50%; } ';
