...
<div id="login_idx">
    <div id="content-area">
        ...
        <div class="form_area">
            ...
            <?= $this->Html->link('パスワードをお忘れの場合',['action' => 'resetPassword'], array('style'=>'display: flex; justify-content:start; vertical height: 13px; margin-top: 10px; margin-bottom: 20px; font-size: 11px;color:#A0BDD2;')) ?>
        </div>
    </div>
</div>
