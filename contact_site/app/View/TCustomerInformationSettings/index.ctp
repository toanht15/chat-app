...
<div id='tcustomerinformationsettings_idx' class="card-shadow">
  ...
  <div id='tcustomerinformationsettings_description'>
    <span class="pre">訪問ユーザ情報として記録する項目（会社名、氏名、連絡先など）を自由に設定することができます。記録された情報は<?php echo($coreSettings[C_COMPANY_DISABLE_REAL_TIME_MONITOR] ? '有人応対' : 'リアルタイムモニタ') ?>ーや履歴から確認可能です。
