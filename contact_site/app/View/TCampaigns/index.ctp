...
<span>サイトアクセス時のURL（ランディングURL）に特定のパラメータを含む場合にリアルタイムモニタ（および履歴）に任意のキャンペーン名を表示させることができます。どの広告からの流入かを可視化したい場合などに本設定をお使いください。
</span>
</div>

<div id='tcampaigns_menu' class="p20l">
  <ul class="fLeft" >
    <li>
...
<div id='tcampaigns_list' class="p20xlrt">
  <table>
    <thead>
      <tr>
