...
<div id='tcampaigns_idx' class="card-shadow">
  ...
  <div id='tcampaigns_add_title'>
    <div class="fLeft"><i class="fal fa-trophy fa-2x"></i></div>
        ...
        <span>
          <a>
            <?= $this->Html->image('add.png', array(
              ...
              'class'=>'btn-shadow'.($coreSettings[C_COMPANY_USE_CAMPAIGN] ? " btn-shadow disOffgreenBtn commontooltip" : " disOffgrayBtn  commontooltip disabled"),
