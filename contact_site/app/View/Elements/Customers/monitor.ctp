...
<div id='customer_list'>
  ...
  <div id="list_body">
    <table fixed-header>
      ...
      <tbody ng-cloak>
        <tr ng-repeat="monitor in search(monitorList) | orderObjectBy : '-chatUnreadId-chat' | limitTo : 50" ng-dblclick="showDetail(monitor.tabId, monitor.sincloSessionId)" id="monitor_{{monitor.tabId}}">
          <!-- /* 状態 */ -->
          <td class="tCenter">
