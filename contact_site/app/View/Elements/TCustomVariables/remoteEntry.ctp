...
<?= $this->Form->create('TCustomVariable', array('action' => 'add')); ?>
  <div class="form01">
    ...
    <div id="filterType2Tooltip" class="explainTooltip">
      <icon-annotation>
        <ul>
          <li><span class="detail" style="width:550px;">ウィジェットを表示している画面上から取得する値をCSSのセレクタと同様の記入方法で設定します。<br><br>例１）以下のHTMLで「田中太郎」を取得したい場合 => #user_name<br><br>&lt;span id=&quot;user_name&quot;&gt;田中太郎&lt;/span&gt;<br><br>例２）以下のHTMLで「田中太郎」を取得したい場合 => #nav-tools .nav-line-1<br><br>&lt;div id=&quot;nav-tools&quot;&gt;<br> 　　(中略)<br>  &lt;span class=&quot;nav-line-1&quot;&gt;田中太郎&lt;/span&gt;<br>  &lt;span class=&quot;nav-line-2&quot;&gt;リスト&lt;span class=&quot;nav-icon&quot;&gt;&lt;/span&gt;&lt;/span&gt;<br> 　　(中略)<br>&lt;/div&gt;ウィジェットを表示している画面上から取得する値をCSSのセレクタと同様の記入方法で設定します。<br><br>例１）以下のHTMLで「田中太郎」を取得したい場合 => #user_name<br><br><div style="color:#4c9db3">&lt;span id=&quot;user_name&quot;&gt;田中太郎&lt;/span&gt;</div><br>例２）以下のHTMLで「田中太郎」を取得したい場合 => #nav-tools .nav-line-1<br><br><div style="color:#4c9db3">&lt;div id=&quot;nav-tools&quot;&gt;<br> 　　(中略)<br>  &lt;span class=&quot;nav-line-1&quot;&gt;田中太郎&lt;/span&gt;<br>  &lt;span class=&quot;nav-line-2&quot;&gt;リスト&lt;span class=&quot;nav-icon&quot;&gt;&lt;/span&gt;&lt;/span&gt;<br> 　　(中略)<br>&lt;/div&gt;</div></span></li>
        </ul>
      </icon-annotation>
    </div>
  </div>
