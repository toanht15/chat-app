    ...
    <div>
      <span>
        ...
        <div class="questionBallon">
          <icon class="questionBtn" data-tooltip="ヘルプメッセージが入ります">?</icon>
        </div>
        <?= $this->Form->input('variablename', array('placeholder' => '変数名', 'div' => false, 'label' => false, 'maxlength' => 100,'style' => 'margin-left: 15px;')) ?>
      </span>
    </div>
    <div>
      <span>
        ...
        <?= $this->Form->input('attribute_value', array('placeholder' => '属性値', 'div' => false, 'label' => false, 'maxlength' => 100,'style' => 'margin-left: 15px;')) ?>
      </span>
    </div>
    <div>
