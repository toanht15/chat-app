  ...
  <div class="keywordWrapper">
    ...
    <div class="wrap pb" ng-if="setItem.keyword_contains_enabled">
      <div class="containsSetting">
        <input type="text" ng-model="setItem.keyword_contains" name="keyword_contains" maxlength="300" ng-required="!((setItem.keyword_contains.length > 0) || (setItem.keyword_exclusions.length > 0))">
    ...
    <div class="wrap" ng-if="setItem.keyword_exclusions_enabled">
      <div class="exclusionSetting">
        ...
        <input type="text" ng-model="setItem.keyword_exclusions" name="keyword_exclusions" maxlength="300" ng-required="!((setItem.keyword_contains.length > 0) || (setItem.keyword_exclusions.length > 0))">
