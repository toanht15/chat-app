...
<section id="sample_widget_area" ng-cloak>
  <style>
    #sincloBox {
      ...
      /* z風 */
      /*box-shadow: 0px -2px 3px 2px rgba(0,0,0,calc(({{widgetSettings.box_shadow}} * 0.1) / 2));*/
      /* d風 */
      /* box-shadow: 0 10px 20px rgba(0,0,0,calc(({{widgetSettings.box_shadow}} * 0.1) / 2)); */
      border-radius: {{widgetSettings.radius_ratio}}px {{widgetSettings.radius_ratio}}px 0 0;
    }
...
*/
      #sincloBox p#widgetSubTitle { background-color: {{widgetSettings.header_background_color}}; margin: 0; padding: 7px 0; text-align: left; border-width: 0 1px 0 1px; border-color: {{widgetSettings.widget_border_color}}; border-style: solid; padding-left: 77px; font-weight: bold; color: {{widgetSettings.main_color}}; height: 29px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
      #sincloBox p#widgetSubTitle:not(.notNoneWidgetOutsideBorder) { border:none; }
      #sincloBox p#widgetSubTitle.details { color: {{widgetSettings.sub_title_text_color}}; }
      #sincloBox p#widgetDescription { background-color: {{widgetSettings.header_background_color}}; margin: 0; padding-bottom: 7px; text-align: left; border-width: 0 1px 1px 1px; border-color: {{widgetSettings.widget_border_color}}; border-style: solid; padding-left: 77px; height: 23px; color: {{widgetSettings.other_text_color}}; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
      #sincloBox p#widgetDescription:not(.notNoneWidgetOutsideBorder) { border-left:none; border-right:none; }
      #sincloBox p#widgetDescription.details { color: {{widgetSettings.description_text_color}}; border-bottom-color: {{widgetSettings.widget_inside_border_color}}; }
      #sincloBox p#widgetDescription.details:not(.notNone) { border-bottom:none }
      #sincloBox section { display: inline-block; width: 285px; border: 1px solid {{widgetSettings.widget_border_color}}; border-top: none; }
      #sincloBox section:not(.notNoneWidgetOutsideBorder) { border: 1px solid {widgetSettings.{widget_inside_border_color}};  border-top: none; border-left:none; border-right:none; }
      #sincloBox section.details { border-bottom-color: {{widgetSettings.widget_inside_border_color}}; }
    ...
    <?php if ( $coreSettings[C_COMPANY_USE_CHAT] ) :?>
      ...
      #sincloBox ul#chatTalk.details { background-color: {{widgetSettings.chat_talk_background_color}}; }
      ...
      #sincloBox ul#chatTalk li span.cName { display: block; color: {{widgetSettings.main_color}}!important; font-weight: bold; font-size: 13px; margin: 0 0 5px 0; }
      ...
      #sincloBox ul#chatTalk li span.sinclo-radio [type="radio"] + label { position: relative; display: inline-block; width: 100%; cursor: pointer; padding: 0 0 0 15px; color:{{widgetSettings.re_text_color}}; min-height: 12px; }
      ...
      #sincloBox section#chatTab textarea#sincloChatMessage.details.notNone { border: 1px solid {{widgetSettings.message_box_border_color}}!important; }
      #sincloBox section#chatTab textarea#sincloChatMessage.notNone { border-radius: 5px 0 0 5px!important; border: 1px solid {{widgetSettings.chat_talk_border_color}}!important; border-right-color: transparent!important; }
      #sincloBox section#chatTab textarea#sincloChatMessage.notNone:focus { border-color: {{widgetSettings.main_color}}!important; outline: none!important; border-right-color: transparent!important; }
      #sincloBox section#chatTab textarea#sincloChatMessage:not(.notNone){ border: none!important }
      #sincloBox section#chatTab #sincloChatSendBtn{ width: 20%; height: 100%; padding: 20px 0; border-radius: 0 5px 5px 0; cursor: pointer; margin: 0 auto; float: right; text-align: center; background-color: {{widgetSettings.main_color}}!important; color: {{widgetSettings.string_color}}; font-weight: bold; font-size: 1.2em;}
      #sincloBox section#chatTab #sincloChatSendBtn.details{ background-color: {{widgetSettings.chat_send_btn_background_color}}!important; }
      ...
      #sincloBox section#chatTab #sincloChatSendBtn span { color: {{widgetSettings.string_color}} }
      #sincloBox section#chatTab #sincloChatSendBtn span.details { color: {{widgetSettings.chat_send_btn_text_color}} }
      #sincloBox section#chatTab #messageBox.messageBox{border-top: 1px solid {{widgetSettings.widget_border_color}}; padding: 0.5em;}
      #sincloBox section#chatTab #messageBox.messageBox:not(.notNoneWidgetOutsideBorder) { border-top:none; }
      #sincloBox section#chatTab #messageBox.messageBox.details{ background-color: {{widgetSettings.chat_message_background_color}}; border-top: 1px solid {{widgetSettings.widget_inside_border_color}}; }
    ...
    <?php if ( $coreSettings[C_COMPANY_USE_SYNCLO] || (isset($coreSettings[C_COMPANY_USE_DOCUMENT]) && $coreSettings[C_COMPANY_USE_DOCUMENT]) ) :?>
      ...
      #sincloBox section#callTab.details { background-color: {{widgetSettings.chat_talk_background_color}}; }
      #sincloBox section#callTab #telNumber { overflow: hidden; color: {{widgetSettings.main_color}}; font-weight: bold; margin: 0 auto; text-align: center }
      ...
      #sincloBox section#callTab #telIcon { background-color: {{widgetSettings.main_color}}; display: block; width: 50px; height: 50px; float: left; border-radius: 25px; padding: 3px }
      #sincloBox section#callTab #telTime { font-weight: bold; color: {{widgetSettings.main_color}}; margin: 0 auto; white-space: pre-line; font-size: 11px; text-align: center; padding: 0 0 5px; height: 20px }
    ...
    <?php if ( $coreSettings[C_COMPANY_USE_CHAT] && ($coreSettings[C_COMPANY_USE_SYNCLO] || (isset($coreSettings[C_COMPANY_USE_DOCUMENT]) && $coreSettings[C_COMPANY_USE_DOCUMENT])) ) :?>
      ...
      #sincloBox section#navigation ul li { position: relative; overflow: hidden; cursor: pointer; color: {{widgetSettings.other_text_color}}; width: 50%; text-align: center; display: table-cell; padding: 10px 0; height: 40px }
      #sincloBox section#navigation ul li:not(.details) { border-left: 1px solid {{widgetSettings.widget_border_color}}; }
      #sincloBox section#navigation ul li:not(.details):not(.notNoneWidgetOutsideBorder) { border-left:none; }
      #sincloBox section#navigation ul li:last-child { border-right: 1px solid {{widgetSettings.widget_border_color}}; }
      ...
      #sincloBox section#navigation ul li:not(.selected) { border-bottom: 1px solid {{widgetSettings.widget_border_color}}; }
      #sincloBox section#navigation ul li:not(.selected):not(.notNoneWidgetOutsideBorder) { border-bottom:none; }

      #sincloBox section#navigation ul li.selected.details { background-color: {{widgetSettings.chat_talk_background_color}}; }
      #sincloBox section#navigation ul li:not(.selected).details {  }

      #sincloBox section#navigation ul li.details:not(.selected) { border-bottom: 1px solid {{widgetSettings.widget_inside_border_color}} }
      #sincloBox section#navigation ul li.details:not(.selected):not(.notNone) { border-bottom: none }
      #sincloBox section#navigation ul li[data-tab='call'].details:not(.selected){ border-left: 1px solid {{widgetSettings.widget_inside_border_color}}; }
      #sincloBox section#navigation ul li[data-tab='call'].details:not(.selected):not(.notNone){ border-left: none }
      #sincloBox section#navigation ul li[data-tab='chat'].details:not(.selected){ border-right: 1px solid {{widgetSettings.widget_inside_border_color}}; }
      #sincloBox section#navigation ul li[data-tab='chat'].details:not(.selected):not(.notNone){ border-right: none }
      #sincloBox section#navigation ul li.selected::after{ content: " "; border-bottom: 2px solid {{widgetSettings.main_color}}; position: absolute; bottom: 0px; left: 5px; right: 5px;}
...
*/
      ...
      #sincloBox section#navigation ul li.selected::before{ color: {{widgetSettings.main_color}}; }
    <?php endif; ?>
    <?php if ( $coreSettings[C_COMPANY_USE_SYNCLO] || (isset($coreSettings[C_COMPANY_USE_DOCUMENT]) && $coreSettings[C_COMPANY_USE_DOCUMENT]) ) :?>
      #sincloBox span#sincloAccessInfo{ height: 26.5px; display: block; padding-left: 0.5em; padding-top: 5px; padding-bottom: 5px; border-top: 1px solid {{widgetSettings.widget_border_color}}; font-size: 0.9em; }
      #sincloBox span#sincloAccessInfo:not(.notNoneWidgetOutsideBorder) { border-top:none; }
      #sincloBox span#sincloAccessInfo.details{ border-top: 1px solid {{widgetSettings.widget_inside_border_color}}; }
      #sincloBox span#sincloAccessInfo.details:not(.notNone){ border-top: none; }
    <?php endif; ?>
      #sincloBox #footer{ height: 26.5px; padding: 5px 0; text-align: center; border: 1px solid {{widgetSettings.widget_border_color}}; color:#A1A1A1!important; font-size: 11px;margin: 0; border-top: none; }
    ...
    <span id="mainImage" class="widgetOpener" ng-hide="spHeaderLightToggle() || mainImageToggle !== '1'">
      <img ng-src="{{widgetSettings.main_image}}" err-src="<?=$gallaryPath?>chat_sample_picture.png" width="62" height="70" alt="チャット画像">
    </span>
    <!-- 画像 -->
    <div>
      <!-- タイトル -->
      <p id="widgetTitle" class="widgetOpener notSelect" ng-class="{center: spHeaderLightToggle() || mainImageToggle !== '1',middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3', spText:showWidgetType === 3}">{{widgetSettings.title}}</p>
      <!-- タイトル -->
    </div>
...
<!--
      <p ng-if="subTitleToggle == '1' && color_setting_type === '0' || color_setting_type === false"" id="widgetSubTitle" >{{widgetSettings.sub_title}}</p>
      <p ng-if="subTitleToggle == '1' && color_setting_type === '1' || color_setting_type === true" id="widgetSubTitle" class="details">{{widgetSettings.sub_title}}</p>
 -->
      <p ng-if="subTitleToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false}" class="details">{{widgetSettings.sub_title}}</p>
...
<!-- 仕様変更、常に高度な設定が当たっている状態とする -->
<!--
      <p ng-if="descriptionToggle == '1' && color_setting_type === '0' || color_setting_type === false" id="widgetDescription" >{{widgetSettings.description}}</p>
      <p ng-if="descriptionToggle == '1' && color_setting_type === '1' || color_setting_type === true" id="widgetDescription" class="details" ng-class="{ notNone:widget_inside_border_none === ''||widget_inside_border_none === false}">{{widgetSettings.description}}</p>
 -->
      <p ng-if="descriptionToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false}">{{widgetSettings.description}}</p>
...
<!--
 ...
 -->
      <section id="callTab" ng-hide="widget.showTab !== 'call'" class="details" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, middleSize: widgetSizeTypeToggle === '2',largeSize: widgetSizeTypeToggle === '3'}">
        ...
        <!-- 受付電話番号 -->
        <pre id="telNumber" ng-class="{notUseTime: timeTextToggle !== '1',middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3'}" >{{widgetSettings.tel}}</pre>
        <!-- 受付電話番号 -->

        <!-- 受付時間 -->
        <pre id="telTime" ng-if="timeTextToggle == '1'" ng-class="{middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3'}">受付時間： {{widgetSettings.time_text}}</pre>
        <!-- 受付時間 -->

        </div>

        <!-- テキスト -->
        <div id="telContent" ng-class="{middleSize: widgetSizeTypeToggle === '2',largeSize: widgetSizeTypeToggle === '3'}"><div class="tblBlock"><span ng-class="{middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3'}">{{widgetSettings.content}}</span></div></div>
        <!-- テキスト -->
...
*/
      ...
      #sincloBox ul#chatTalk.details { background-color: {{widgetSettings.chat_talk_background_color}}; }
      #sincloBox ul#chatTalk li { border-radius: 5px; background-color: #FFF; margin: 5px 0 0; padding: 3px; font-size: 11px; line-height: 1.4; white-space: pre; color: {{widgetSettings.message_text_color}}; }
      #sincloBox ul#chatTalk div.liLeft { text-align: left; }
      #sincloBox ul#chatTalk div.liRight { text-align: right; }
      #sincloBox ul#chatTalk li.boxType { word-wrap: break-word; word-break: break-all; }
      #sincloBox ul#chatTalk li.balloonType { display: inline-block; position: relative; padding: 5px 15px; text-align: left!important; word-wrap: break-word; word-break: break-all; border-radius: 12px; }
      ...
      #sincloBox ul#chatTalk li.balloonType.chat_right { margin-left: 15px }
      #sincloBox ul#chatTalk li.balloonType.chat_left { margin-right: 10px }
      #sincloBox ul#chatTalk li span.cName { display: block; color: {{widgetSettings.main_color}}!important; font-weight: bold; font-size: 12px; margin: 0 0 5px 0; }
      #sincloBox ul#chatTalk li span.cName.details{ color: {{widgetSettings.c_name_text_color}}!important;}
      #sincloBox ul#chatTalk li span.cName:not(.details){ color: {{widgetSettings.main_color}}!important;}
      ...
      #sincloBox section#chatTab textarea#sincloChatMessage.notNone:focus { border-color: {{widgetSettings.main_color}}!important; outline: none!important; border-right-color: transparent!important; }
      #sincloBox section#chatTab textarea#sincloChatMessage:not(.notNone){ border: none!important }
      #sincloBox section#chatTab #sincloChatSendBtn{ width: 20%; height: 100%; padding: 1em 0; border-radius: 0 5px 5px 0; cursor: pointer; margin: 0 auto; float: right; text-align: center; background-color: {{widgetSettings.main_color}}!important; color: {{widgetSettings.string_color}}; font-weight: bold; font-size: 1.2em;}
      #sincloBox section#chatTab #sincloChatSendBtn.details{ background-color: {{widgetSettings.chat_send_btn_background_color}}!important; }
      #sincloBox section#chatTab #sincloChatSendBtn span { color: {{widgetSettings.string_color}} }
      #sincloBox section#chatTab #sincloChatSendBtn span.details { color: {{widgetSettings.chat_send_btn_text_color}} }
      #sincloBox section#chatTab #messageBox.messageBox{border-top: 1px solid {{widgetSettings.widget_border_color}}; padding: 0.5em;}
...
<!-- chat_message_copy 0 stayt -->
    <div ng-if="chat_message_copy == '0'">
      <!-- タイトル -->
      <p id="widgetTitle" class="widgetOpener" ng-class="{center: mainImageToggle == '2'}" >{{widgetSettings.title}}</p>
      <!-- タイトル -->
    </div>
<!-- chat_message_copy 0 end -->
...
<!-- chat_message_copy 1 stayt -->
    <div ng-if="chat_message_copy == '1'">
      <!-- タイトル -->
      <p id="widgetTitle" class="widgetOpener" ng-class="{center: mainImageToggle == '2'}" style = "user-select: none;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;">{{widgetSettings.title}}</p>
      <!-- タイトル -->
    </div>
<!-- chat_message_copy 1 end -->
...
<!-- chat_message_copy 0 stayt -->
        <ul id="chatTalk" class="details" ng-if="chat_message_copy == '0'">
          ...
          <div style="height: auto!important; padding:0;">
            <li id="sample_widget_re_message" class="sinclo_re chat_left" ng-class="{notNone:re_border_none === '' || re_border_none === false, boxType: chat_message_design_type == 1, balloonType: chat_message_design_type == 2}" ng-style="{backgroundColor:makeFaintColor()}"><span class="cName details" >{{widgetSettings.sub_title}}</span><span class="details"></span></li>
          </div>
          <!-- <div style="height: auto!important; padding:0;">
            <li class="showAnimationSample sinclo_re chat_left" ng-class="{notNone:re_border_none === '' || re_border_none === false, boxType: chat_message_design_type == 1, balloonType: chat_message_design_type == 2}" ng-style="{backgroundColor:makeFaintColor()}"><span class="cName details" >{{widgetSettings.sub_title}}</span><span class="details">○○についてですね<br>どのようなご質問でしょうか？</span></li>
          </div> -->
        </ul>
<!-- chat_message_copy 0 end -->
...
<!-- chat_message_copy 1 end -->
        ...
        <div id="messageBox" class="messageBox details" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false }">
          <textarea name="sincloChat" id="sincloChatMessage" class="details" ng-class="{ notNone:message_box_border_none === ''||message_box_border_none === false}" placeholder="メッセージを入力してください{{widgetSettings.chat_area_placeholder_sp}}"></textarea>
