...
*/
    ...
    <?php if ( $coreSettings[C_COMPANY_USE_CHAT] ) :?>
      ...
      #sincloBox ul#chatTalk li.sinclo_se.details { background-color: {{widget.widgetSizeTypeToggle()}}; }
      ...
      #sincloBox ul#chatTalk li.sinclo_se.balloonType:before { height: 0px; content: ""; position: absolute; bottom: 0px; left: calc(100% - 3px); margin-top: -10px; z-index: 2; border: 5px solid transparent; border-left: 5px solid {{widget.widgetSizeTypeToggle()}}; border-bottom: 5px solid {{widget.widgetSizeTypeToggle()}}; }
...
<!--
    <div id="addBtn" class="widgetOpener" ng-class="{closeButtonSetting: widget.closeButtonSettingToggle === '2'}" style="display: none;"></div>
 -->
    <div id="closeBtn" ng-class="{closeButtonSetting: widget.closeButtonSettingToggle === '2'}"></div>
...
<!--
 ...
 -->
      <p ng-if="subTitleToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details">{{widget.settings['sub_title']}}</p>
      <p ng-if="subTitleToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}"></p>
      <!-- サブタイトル -->
...
<!--
      ...
      <p ng-if="descriptionToggle == '1' && color_setting_type === '1' || color_setting_type === true" id="widgetDescription" class="details" ng-class="{ notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}">{{widget.settings['description']}}</p>
 -->
      <p ng-if="descriptionToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}">{{widget.settings['description']}}</p>
      <p ng-if="descriptionToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false }"></p>
      <!-- 説明文 -->
    </div>
    <div id="miniTarget">
    <?php if ( $coreSettings[C_COMPANY_USE_CHAT] ) :?>
...
<!-- chat_message_copy 0 stayt -->
        <span id="sincloAccessInfo" ng-if="chat_message_copy == '1'" class="details" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false }" style="user-select: none;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;" ng-hide="widget.showWidgetType === 3">ウェブ接客コード：●●●●</span>
<!-- chat_message_copy 0 end -->

<!-- chat_message_copy 1 stayt -->
        <span id="sincloAccessInfo" ng-if="chat_message_copy == '0'" class="details" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false }" ng-hide="widget.showWidgetType === 3">ウェブ接客コード：●●●●</span>
<!-- chat_message_copy 1 end -->
...
<!--
 ...
 -->
    ...
    <?php endif; ?>
<!-- chat_message_copy 0 stayt -->
      <p id="footer" ng-if="chat_message_copy == '1'" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" style="user-select: none;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;">Powered by <a target="sinclo" href="https://sinclo.medialink-ml.co.jp/lp/?utm_medium=web-widget&utm_campaign=widget-referral">sinclo</a></p>
<!-- chat_message_copy 0 end -->

<!-- chat_message_copy 1 stayt -->
      <p id="footer" ng-if="chat_message_copy == '0'" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" >Powered by <a target="sinclo" href="https://sinclo.medialink-ml.co.jp/lp/?utm_medium=web-widget&utm_campaign=widget-referral">sinclo</a></p>
<!-- chat_message_copy 1 end -->
    </div>
  </div>
...
*/
      ...
      #sincloBox ul#chatTalk li.sinclo_se.notNone { border: 1px solid {{widget.getTalkBorderColor('se')}}; }
      #sincloBox ul#chatTalk li.sinclo_se.balloonType { margin-right: 15px; border-bottom-right-radius: 0px; }
      #sincloBox ul#chatTalk li.sinclo_se.balloonType:before { height: 0px; content: ""; position: absolute; bottom: 0px; left: calc(100% - 3px); margin-top: -10px; border: 5px solid transparent; border-left: 5px solid {{widget.widgetSizeTypeToggle()}}; border-bottom: 5px solid {{widget.widgetSizeTypeToggle()}}; z-index: 2; }
      #sincloBox ul#chatTalk li.sinclo_se.balloonType:after { height: 0px; content: ""; position: absolute; bottom: -1px; left: 100%; margin-top: -9px; border: 5px solid transparent; z-index: 1; }
      #sincloBox ul#chatTalk li.sinclo_se.balloonType.notNone:after { border-left: 5px solid {{widget.getTalkBorderColor('se')}}; border-bottom: 5px solid {{widget.getTalkBorderColor('se')}}; }
      #sincloBox ul#chatTalk li.sinclo_re.notNone { border: 1px solid {{widget.getTalkBorderColor('re')}}; }
      #sincloBox ul#chatTalk li.sinclo_re.balloonType { margin-left: 10px; padding-right: 20px; border-bottom-left-radius: 0px; }
...
<!-- chat_message_copy 0 stayt -->
    <div ng-if="chat_message_copy == '0'">
      <!-- タイトル -->
      <p id="widgetTitle" class="widgetOpener" ng-class="{center: mainImageToggle == '2'}" >{{widget.settings['title']}}</p>
      <!-- タイトル -->
    </div>
<!-- chat_message_copy 0 end -->
...
<!-- chat_message_copy 1 stayt -->
    <div ng-if="chat_message_copy == '1'">
      <!-- タイトル -->
      <p id="widgetTitle" class="widgetOpener" ng-class="{center: mainImageToggle == '2'}" style = "user-select: none;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;">{{widget.settings['title']}}</p>
      <!-- タイトル -->
    </div>
<!-- chat_message_copy 1 end -->
...
<!-- chat_message_copy 0 stayt -->
        <ul id="chatTalk" class="details" ng-if="chat_message_copy == '0'">
          ...
          <div style="height: auto!important; padding:0;">
            <li id="sample_widget_re_message" class="sinclo_re chat_left" ng-class="{notNone:re_border_none === '' || re_border_none === false, boxType: chat_message_design_type == 1, balloonType: chat_message_design_type == 2}" ng-style="{backgroundColor:widget.makeFaintColor()}"><span class="cName details" >{{widget.settings['sub_title']}}</span><span class="details"></span></li>
          </div>
          <!-- <div style="height: auto!important; padding:0;">
...
<!-- chat_message_copy 1 end -->
        ...
        <div id="messageBox" class="messageBox details" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false }">
          <textarea name="sincloChat" id="sincloChatMessage" class="details" ng-class="{ notNone:message_box_border_none === ''||message_box_border_none === false}" placeholder="メッセージを入力してください{{widget.settings['chat_area_placeholder_sp']}}"></textarea>
