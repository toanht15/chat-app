  ...
  <div id="sincloBox" ng-if="showWidgetType !== 2"  ng-class="{middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3'}">
    ...
    <?php if ( $coreSettings[C_COMPANY_USE_CHAT] ) :?>
      <section id="chatTab" ng-hide="widget.showTab !== 'chat'" ng-class="{middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3'}">
        ...
        <div ng-if="chat_message_copy == '2'" style="border-top: 1px solid #E8E7E0; padding: 0.5em; user-select: none; -moz-user-select: none; -webkit-user-select: none; -ms-user-select: none;">
        ...
        <div ng-if="chat_message_copy == '1'" style="border-top: 1px solid #E8E7E0; padding: 0.5em;">
          <textarea name="sincloChat" id="sincloChatMessage" placeholder="メッセージを入力してください&#13;&#10;{{chat_area_placeholder_pc}}"></textarea>
          <a id="sincloChatSendBtn" class="notSelect" ng-class="{middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3'}"><span>送信</span></a>
        </div>
      <?php if ( $coreSettings[C_COMPANY_USE_SYNCLO] || (isset($coreSettings[C_COMPANY_USE_DOCUMENT]) && $coreSettings[C_COMPANY_USE_DOCUMENT]) ) :?>
        <span id="sincloAccessInfo" ng-if="chat_message_copy == '2'" style="height: 26.5px; display: block; padding-left: 0.5em; padding-top: 5px; padding-bottom: 5px; border-top: 1px solid #E8E7E0; font-size: 0.9em; user-select: none;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;" ng-hide="showWidgetType === 3">ウェブ接客コード：●●●●</span>
        <span id="sincloAccessInfo" ng-if="chat_message_copy == '1'" style="height: 26.5px; display: block; padding-left: 0.5em; padding-top: 5px; padding-bottom: 5px; border-top: 1px solid #E8E7E0; font-size: 0.9em;" ng-hide="showWidgetType === 3">ウェブ接客コード：●●●●</span>
        <?php endif; ?>
      </section>
    <?php endif; ?>
    <?php if ( $coreSettings[C_COMPANY_USE_SYNCLO] || (isset($coreSettings[C_COMPANY_USE_DOCUMENT]) && $coreSettings[C_COMPANY_USE_DOCUMENT]) ) :?>
    ...
    <?php endif; ?>
      <p ng-if="chat_message_copy == '2'" style="height: 26.5px; padding: 5px 0;text-align: center;border: 1px solid #E8E7E0;color: #A1A1A1!important;font-size: 11px;margin: 0;border-top: none; user-select: none;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;">Powered by <a target="sinclo" href="https://sinclo.medialink-ml.co.jp/lp/?utm_medium=web-widget&utm_campaign=widget-referral">sinclo</a></p>
      <p ng-if="chat_message_copy == '1'" style="height: 26.5px; padding: 5px 0;text-align: center;border: 1px solid #E8E7E0;color: #A1A1A1!important;font-size: 11px;margin: 0;border-top: none;">Powered by <a target="sinclo" href="https://sinclo.medialink-ml.co.jp/lp/?utm_medium=web-widget&utm_campaign=widget-referral">sinclo</a></p>
    </div>
  </div>
...
<!-- スマホ版 -->
  <div id="sincloBox" ng-if="showWidgetType === 2">
    ...
    <div id="miniTarget">
      <section id="chatTab">
        <ul id="chatTalk" ng-if="chat_message_copy == '1'">
          <div style="height: auto!important; padding:0;" ng-class="{liLeft: chat_message_design_type == 1, liRight: chat_message_design_type == 2}">
        ...
        <ul id="chatTalk" ng-if="chat_message_copy == '2'" style = "user-select: none;-moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;" >
          <div style="height: auto!important; padding:0;" ng-class="{liLeft: chat_message_design_type == 1, liRight: chat_message_design_type == 2}">
            <li class="sinclo_se chat_right" ng-class="{boxType: chat_message_design_type == 1, balloonType: chat_message_design_type == 2}">○○について質問したいのですが</li>
          </div>
          <div style="height: auto!important; padding:0;">
