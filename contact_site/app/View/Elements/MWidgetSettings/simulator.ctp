<section id="sample_widget_area" ng-cloak>
	...
	<style>
		...
		#sincloBox p#widgetDescription { margin: 0; padding-bottom: 7px; text-align: left; border-width: 0 1px 0 1px; border-color: #E8E7E0; border-style: solid; padding-left: 77px; height: 23px; color: #8A8A8A; }
		...
		#sincloBox section#navigation ul li { position: relative; overflow: hidden; cursor: pointer; color: #8A8A8A; width: 50%; text-align: center; display: table-cell; padding: 10px 0; border: 1px solid #E8E7E0; height: 40px }
		#sincloBox section#navigation ul li:last-child { border-left: none!important; }
		#sincloBox section#navigation ul li.selected { background-color: #FFFFFF; border-bottom: none }
	...
	<!-- 画像 -->
	<span style="position: absolute; top: 7px; left: 7px;"><?=$this->Html->image('chat_sample_picture.png', ['width' => 62, 'height' => 70])?></span>
	<!-- 画像 -->
