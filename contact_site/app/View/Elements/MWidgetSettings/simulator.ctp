...
<section id="sample_widget_area" ng-cloak>
  ...
  <div id="sincloBox" ng-if="showWidgetType !== 2"  ng-class="{middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3'}">
    ...
    <?php if ( $coreSettings[C_COMPANY_USE_CHAT] ) :?>
      ...
      #sincloBox ul#chatTalk.middleSize { width: 100%; height: 239.5px; padding: 5px; margin: 0}
      #sincloBox ul#chatTalk.largeSize { width: 100%; height: 288px; padding: 5px; margin: 0}
      ...
      #sincloBox ul#chatTalk li.middleSize { margin: 5px 0; padding: 5px; font-size: 13px; }
      #sincloBox ul#chatTalk li.largeSize { margin: 5px 0; padding: 5px; font-size: 13px; }
