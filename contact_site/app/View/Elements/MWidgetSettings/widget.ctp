<div id="sincloBox" <?= !empty($isSpPreview) ? 'class="sp-preview" ng-class=\'{noTextarea: chat_init_show_textarea === "2", fullSize:sp_maximize_size_type==="2", simpleHeader:sp_header_light_flg==="1"}\' ng-show="showWidgetType === 3 && viewSpWidget"' : "ng-if=\"showWidgetType !== 2 && showWidgetType !== 3\"" ?>  ng-hide="showWidgetType === 4 || (showWidgetType === 3 && !viewSpWidget)" ng-class="{middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && (widgetSizeTypeToggle === '3' || widgetSizeTypeToggle === '4'),customSize: showWidgetType === 1 && widgetSizeTypeToggle === '5'}">
  <style>
    ...
    #sincloBox section.middleSize { width: 344px; }
    ...
    #sincloBox ul#chatTalk.middleSize { height: {{getActualChatTalkHeight()}}px; padding: 0px 5px 45.4px 5px;}
    #sincloBox ul#chatTalk.largeSize { height: {{getActualChatTalkHeight()}}px; padding: 0px 5px 60px 5px;}
    #sincloBox ul#chatTalk.customSize { height: {{getActualChatTalkHeight()}}px; max-height: 590px; min-height: 194px; padding: 0px 5px calc(30.8px + ({{widget_custom_height}} - 194) * 14.6px / 90 ) 5px;}
    ...
    #sincloBox ul#chatTalk > div.with_icon .icon_container { width: calc(({{widget_custom_height}}px + 382px)/18); }
    ...
    #sincloBox ul#chatTalk > div.with_icon img.customSize { width: calc(({{widget_custom_height}}px + 346px)/18); max-width: 40px; }
    #sincloBox section#chatTab ul#chatTalk div.icon_container.customSize .img_wrapper { height: calc(({{widget_custom_height}}px + 346px)/18)!important; width: calc(({{widget_custom_height}}px + 346px)/18);}
    ...
    #sincloBox ul#chatTalk li.boxType.arrowBottom.chat_right { border-radius: 12px 12px 0 12px; }
    #sincloBox ul#chatTalk li.boxType.arrowUp.chat_right { border-radius: 12px 0 12px 12px; }
    #sincloBox ul#chatTalk li.boxType.arrowBottom.chat_left { border-radius: 12px 12px 12px 0; }
    #sincloBox ul#chatTalk li.boxType.arrowUp.chat_left { border-radius: 0px 12px 12px 12px; }

    #sincloBox ul#chatTalk li.boxType.chat_right { margin-left: 37.5px; margin-right:10px; }
    #sincloBox ul#chatTalk li.boxType.chat_left { margin-right: 17.5px; margin-left:10px; }
      ...
      <section id="chatTab" ng-hide="widget.showTab !== 'chat'" class="details" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && (widgetSizeTypeToggle === '3' || widgetSizeTypeToggle === '4')}">
        ...
        <ul id="chatTalk" class="details" ng-class="{ middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && (widgetSizeTypeToggle === '3' || widgetSizeTypeToggle === '4'),customSize: showWidgetType === 1 && widgetSizeTypeToggle === '5' ,disableCopy: chat_message_copy == '1'}">
          <div ng-class="setGridDiv('bot')" style= "padding: 0; height: auto!important">
            ...
            <li class="sinclo_re chat_left" style="justify-self:start" ng-style="{backgroundColor:makeFaintColor()}" ng-class="{ notNone:re_border_none === '' || re_border_none === false, middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && (widgetSizeTypeToggle === '3' || widgetSizeTypeToggle === '4' || widgetSizeTypeToggle === '5'), with_icon: chatbotIconToggle == 1 && ( isPictureImage( chatbot_icon ) || isIconImage( chatbot_icon ) ), boxType: chat_message_design_type == 1, balloonType: chat_message_design_type == 2, arrowUp:chat_message_design_type == 1 && chat_message_arrow_position == 1, arrowBottom:chat_message_design_type != 1 || chat_message_arrow_position == 2}"><span class="details" ng-class="{sp:showWidgetType === 3}">これはオートメッセージです。<br>チャットで質問して下さい。</span></li>
          </div>
           <div style="height: auto!important; padding:0;" ng-class="{liBoxRight: chat_message_design_type == 1, liRight: chat_message_design_type == 2}" >
            <li class="sinclo_se chat_right details" ng-class="{ notNone:se_border_none === '' || se_border_none === false, middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && (widgetSizeTypeToggle === '3' || widgetSizeTypeToggle === '4'), boxType: chat_message_design_type == 1, balloonType: chat_message_design_type == 2, arrowUp:chat_message_design_type == 1 && chat_message_arrow_position == 1, arrowBottom:chat_message_design_type != 1 || chat_message_arrow_position == 2}" ><span class="details" ng-class="{sp:showWidgetType === 3}">○○について質問したいのですが</span></li>
          </div>
        ...
        <div id="messageBox" class="messageBox details" ng-if="chat_init_show_textarea === '1'" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, disableCopy: chat_message_copy == '1' }">
          ...
          <a id="sincloChatSendBtn" class="notSelect details" ng-class="checkWidgetSize()" ><span class="details" ng-class="{sp:showWidgetType === 3}">送信</span></a>
        </div>
