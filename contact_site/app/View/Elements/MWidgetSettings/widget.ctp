...
*/
  ...
  <div class="widgetHeaderWrap" ng-class="{sp:showWidgetType === 3}">
    ...
    <div id="titleWrap">
      <!-- タイトル -->
      <p ng-if="widget_title_top_type == '1' && mainImageToggle == '1'" id="widgetTitle" class="widgetOpener notSelect" ng-class="{center: spHeaderLightToggle() || mainImageToggle !== '1',middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3', spText:showWidgetType === 3, sp:showWidgetType === 3}" style = 'text-align: left;padding: 7px 0px 7px 78px;'>{{title}}</p>
      <p ng-if="widget_title_top_type == '2' && mainImageToggle == '1'" id="widgetTitle" class="widgetOpener notSelect" ng-class="{center: spHeaderLightToggle() || mainImageToggle !== '1',middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3', spText:showWidgetType === 3, sp:showWidgetType === 3}">{{title}}</p>
      <p ng-if="widget_title_top_type == '1' && mainImageToggle == '2'" id="widgetTitle" class="widgetOpener notSelect" ng-class="{center: spHeaderLightToggle() || mainImageToggle !== '1',middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3', spText:showWidgetType === 3, sp:showWidgetType === 3}" style = 'text-align: left !important;padding: 7px 0px 7px 15px !important;'>{{title}}</p>
      <p ng-if="widget_title_top_type == '2' && mainImageToggle == '2'" id="widgetTitle" class="widgetOpener notSelect" ng-class="{center: spHeaderLightToggle() || mainImageToggle !== '1',middleSize: showWidgetType === 1 && widgetSizeTypeToggle === '2',largeSize: showWidgetType === 1 && widgetSizeTypeToggle === '3', spText:showWidgetType === 3, sp:showWidgetType === 3}">{{title}}</p>
      <!-- タイトル -->
    ...
    <div id='descriptionSet' class="widgetOpener notSelect" ng-hide=" spHeaderLightToggle() || mainImageToggle == '2' && subTitleToggle == '2' && descriptionToggle == '2'">
      ...
      <!--
       ...
       -->
      <p ng-if="subTitleToggle == '1' && widget_title_name_type == '1' && descriptionToggle == '1' && mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" class="details" style = "text-align:left; padding-left:78px;">{{sub_title}}</p>
      <p ng-if="subTitleToggle == '1' && widget_title_name_type == '2' && descriptionToggle == '1' && mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" class="details" style = "text-align:center; padding-left:70px;">{{sub_title}}</p>
      <p ng-if="subTitleToggle == '1' && widget_title_name_type == '1' && descriptionToggle == '1' && mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" class="details" style = "text-align:left; padding-left:15px;">{{sub_title}}</p>
      <p ng-if="subTitleToggle == '1' && widget_title_name_type == '2' && descriptionToggle == '1' && mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" class="details" style = "text-align:center; padding-left:0px;">{{sub_title}}</p>
      <p ng-if="subTitleToggle == '1' && widget_title_name_type == '1' && descriptionToggle == '2' && mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" style = "text-align:left;height:52px;line-height:52px;padding:0 0 0 78px;">{{sub_title}}</p>
      <p ng-if="subTitleToggle == '1' && widget_title_name_type == '2' && descriptionToggle == '2' && mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" style = "text-align:center;height:52px;line-height:52px;padding:0 0 0 78px;">{{sub_title}}</p>
      <p ng-if="subTitleToggle == '1' && widget_title_name_type == '1' && descriptionToggle == '2' && mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" style = "text-align:left;height:52px;line-height:52px;padding:0 0 0 15px;">{{sub_title}}</p>
      <p ng-if="subTitleToggle == '1' && widget_title_name_type == '2' && descriptionToggle == '2' && mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" style = "text-align:center;height:52px;line-height:52px;padding:0 0 0 0px;">{{sub_title}}</p>
      <p ng-if="subTitleToggle == '2' && descriptionToggle == '1' && mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" style = "height:0px;padding:0px;">&thinsp;</p>
      <p ng-if="subTitleToggle == '2' && descriptionToggle == '1' && mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, sp:showWidgetType === 3}" style = "height:0px;padding:0px;">&thinsp;</p>
      ...
      <!--
       ...
       -->
      <p ng-if="descriptionToggle == '1' && widget_title_explain_type == '1' && subTitleToggle == '1' && mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "text-align:left; padding-left:78px;">{{description}}</p>
      <p ng-if="descriptionToggle == '1' && widget_title_explain_type == '2' && subTitleToggle == '1' && mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "text-align:center; padding-left:70px;">{{description}}</p>
      <p ng-if="descriptionToggle == '1' && widget_title_explain_type == '1' && subTitleToggle == '1' && mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "text-align:left; padding-left:15px;">{{description}}</p>
      <p ng-if="descriptionToggle == '1' && widget_title_explain_type == '2' && subTitleToggle == '1' && mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "text-align:center; padding-left:0px;">{{description}}</p>
      <p ng-if="descriptionToggle == '1' && widget_title_explain_type == '1' && subTitleToggle == '2' && mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "text-align:left;height:52px; line-height:52px; padding-bottom:0px">{{description}}</p>
      <p ng-if="descriptionToggle == '1' && widget_title_explain_type == '2' && subTitleToggle == '2' && mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "text-align:center;height:52px; line-height:52px; padding-bottom:0px">{{description}}</p>
      <p ng-if="descriptionToggle == '1' && widget_title_explain_type == '1' && subTitleToggle == '2' && mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "text-align:left;height:52px; line-height:52px; padding-bottom:0px; padding-left:15px;">{{description}}</p>
      <p ng-if="descriptionToggle == '1' && widget_title_explain_type == '2' && subTitleToggle == '2' && mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "text-align:center;height:52px; line-height:52px; padding-bottom:0px; padding-left:0px;">{{description}}</p>
      <p ng-if="descriptionToggle == '2' && subTitleToggle == '1' &&  mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "height:0px;padding-bottom:0px;">&thinsp;</p>
      <p ng-if="descriptionToggle == '2' && subTitleToggle == '1' &&  mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget_outside_border_none === ''||widget_outside_border_none === false, notNone:widget_inside_border_none === ''||widget_inside_border_none === false, sp:showWidgetType === 3}" style = "height:0px;padding-bottom:0px;">&thinsp;</p>
