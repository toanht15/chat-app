...
*/
    ...
    #sincloBox ul#chatTalk { width: 100%; height: 100px; padding: 0px 5px 30.3px 5px; list-style-type: none; overflow-y: scroll; overflow-x: hidden; margin: 0}
    #sincloBox ul#chatTalk.details { background-color: {{chat_talk_background_color}}; }
    #sincloBox ul#chatTalk li { border-radius: 5px; background-color: #FFF; margin: 10px 0 0; padding: 10px; font-size: 11px; line-height: 1.4; white-space: pre-wrap; color: {{message_text_color}}; }
    ...
    #sincloBox ul#chatTalk li.boxType.chat_right { border-radius: 12px 12px 0 12px; margin-left: 57.7px; margin-right:10px; }
    #sincloBox ul#chatTalk li.boxType.chat_left { border-radius: 12px 12px 12px 0; margin-right: 26.9px; margin-left:10px; }
    #sincloBox ul#chatTalk li.balloonType.chat_right { margin-left: 57.7px }
    #sincloBox ul#chatTalk li.balloonType.chat_left { margin-right: 26.9px }
