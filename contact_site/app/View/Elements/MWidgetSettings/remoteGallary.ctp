...
<ul id="gallaryImage">
  ...
  <li data-name="icon fa-comments normal">
    <i class="icon fal fa-comments bgOn"/>
  </li>
  <li data-name="icon fa-phone normal">
    <i class="icon fal fa-phone bgOn"/>
  </li>
  <li data-name="icon fa-robot normal">
    <i class="icon fal fa-robot bgOn"/>
  </li>
  <li data-name="icon fa-comments invert">
    <i class="icon fal fa-comments bgOff"/>
  </li>
  <li data-name="icon fa-phone invert">
    <i class="icon fal fa-phone bgOff"/>
  </li>
  <li data-name="icon fa-robot invert">
