...
<div ng-controller="SimulatorController as simulator" ng-cloak id="widget_simulator_wrapper">
  ...
  */
      ...
      <?php if ( $coreSettings[C_COMPANY_USE_CHAT] ) :?>
        ...
        #sincloBox ul#chatTalk li.boxType.chat_right { border-radius: 12px 12px 0 12px; margin-right: 10px; margin-left: 31px; }
        #sincloBox ul#chatTalk li.boxType.chat_left { border-radius: 12px 12px 12px 0; margin-left: 10px; margin-right: 31px; }
