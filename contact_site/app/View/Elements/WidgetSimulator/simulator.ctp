...
<div ng-controller="SimulatorController as simulator" ng-cloak id="widget_simulator_wrapper">
  ...
  */
        ...
        #sincloBox ul#chatTalk li span.sinclo-radio [type="radio"] + label.radio-zoom:before { content: ""; vertical-align: middle; position: absolute; top: {{widget.radioButtonBeforeTop}}px; left: 0px; margin-top: -{{widget.radioButtonBeforeTop}}px; width: {{widget.re_text_size}}px; height: {{widget.re_text_size}}px; border: 1px solid #999; border-radius: 50%; background-color: #FFF; }
        ...
        #sincloBox #chatTalk li.sinclo_re.no-wrap span.sinclo-text-line { padding: 0 15px!important; }
        #sincloBox #chatTalk li.sinclo_re div.sinclo-button-wrap {display: flex; margin-top: 10px; justify-content: center; align-items: center; width: 100%;}
