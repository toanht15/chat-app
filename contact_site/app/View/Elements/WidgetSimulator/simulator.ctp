...
<div ng-controller="SimulatorController as simulator" ng-cloak id="widget_simulator_wrapper">
  ...
  */
      ...
      <?php if ( $coreSettings[C_COMPANY_USE_CHAT] ) :?>
        ...
        #sincloBox ul#chatTalk li.boxType.chat_right .smallSizeImg {max-width: 165px; max-height: 120px; }
        #sincloBox ul#chatTalk li.boxType.chat_left .smallSizeImg { max-width: 165px; max-height: 120px; }
        #sincloBox ul#chatTalk li.boxType.chat_right .middleSizeImg {max-width: 215px; max-height: 188px; }
        #sincloBox ul#chatTalk li.boxType.chat_left .middleSizeImg { max-width: 215px; max-height: 188px; }
        #sincloBox ul#chatTalk li.boxType.chat_right .largeSizeImg { max-width: 265px; max-height: 285px; }
        #sincloBox ul#chatTalk li.boxType.chat_left .largeSizeImg { max-width: 265px; max-height: 285px; }
