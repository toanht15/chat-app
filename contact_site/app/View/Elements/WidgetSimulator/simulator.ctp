...
<div ng-controller="SimulatorController as simulator" ng-cloak id="widget_simulator_wrapper">
  ...
  */
      ...
      <div id="titleWrap">
        <!-- タイトル -->
        <p ng-if="widget.settings['widget_title_top_type'] === '1'" id="widgetTitle" class="widgetOpener notSelect" ng-class="{center: widget.spHeaderLightToggle() || widget.mainImageToggle !== '1',middleSize: widget.isMiddleSize,largeSize: widget.isLargeSize, spText:widget.showWidgetType === 3}" style = "text-align:left;padding-left:78px">{{widget.settings['title']}}</p>
        <p ng-if="widget.settings['widget_title_top_type'] === '2'" id="widgetTitle" class="widgetOpener notSelect" ng-class="{center: widget.spHeaderLightToggle() || widget.mainImageToggle !== '1',middleSize: widget.isMiddleSize,largeSize: widget.isLargeSize, spText:widget.showWidgetType === 3}" style = "text-align:center;padding-left:0px;">{{widget.settings['title']}}</p>
        <!-- タイトル -->
  ...
  <!--
   ...
   -->
      <div id='descriptionSet' class="widgetOpener notSelect" ng-hide="widget.spHeaderLightToggle() || widget.mainImageToggle == '2' && widget.subTitleToggle == '2' && widget.descriptionToggle == '2'">
        ...
        <p ng-if="widget.settings['widget_title_name_type'] === '1' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "text-align:left;padding-left:78px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_name_type'] === '2' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "text-align:center;padding-left:70px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_name_type'] === '1' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "text-align:left;padding-left:15px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_name_type'] === '2' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "text-align:center;padding-left:0px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_name_type'] === '1' && widget.descriptionToggle == '2' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "text-align:left;height:52px;line-height:52px;padding:0 0 0 78px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_name_type'] === '2' && widget.descriptionToggle == '2' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "text-align:center;height:52px;line-height:52px;padding:0 0 0 78px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_name_type'] === '1' && widget.descriptionToggle == '2' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "text-align:left;height:52px;line-height:52px;padding:0 0 0 15px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_name_type'] === '2' && widget.descriptionToggle == '2' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "text-align:center;height:52px;line-height:52px;padding:0 0 0 0px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.descriptionToggle == '1' && widget.subTitleToggle == '2' && widget.mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "height:0px;padding:0px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.descriptionToggle == '1' && widget.subTitleToggle == '2' && widget.mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details" style = "height:0px;padding:0px;">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        ...
        <!-- 説明文 -->
        <p ng-if="widget.settings['widget_title_explain_type'] === '1' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" style = "text-align:left;padding-left:78px">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '2' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" style = "text-align:center;padding-left:70px">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '1' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" style = "text-align:left;padding-left:15px">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '2' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" style = "text-align:center;padding-left:0px">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '1' && widget.descriptionToggle == '1' && widget.subTitleToggle == '2' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" style = "text-align:left;height:52px; line-height:52px; padding-bottom:0px; padding-left:15px;">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '2' && widget.descriptionToggle == '1' && widget.subTitleToggle == '2' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" style = "text-align:center;height:52px; line-height:52px; padding-bottom:0px; padding-left:0px;">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.descriptionToggle == '2' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" style = "height:0px;padding-bottom:0px;">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.descriptionToggle == '2' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" style = "height:0px;padding-bottom:0px;">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
