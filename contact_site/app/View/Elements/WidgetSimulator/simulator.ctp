  ...
  <!--
   ...
   -->
      <div id='descriptionSet' class="widgetOpener notSelect" ng-hide="widget.spHeaderLightToggle() || widget.mainImageToggle == '2' && widget.subTitleToggle == '2' && widget.descriptionToggle == '2'">
        ...
        <!-- 説明文 -->
        <p ng-if="widget.settings['widget_title_explain_type'] === '1' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" class="leftPositionImage">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '2' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" class="centerPositionImage">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '1' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" class="leftPositionNoImage">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '2' && widget.descriptionToggle == '1' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" class="centerPositionNoImage">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '1' && widget.descriptionToggle == '1' && widget.subTitleToggle == '2' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" class="leftPositionImageCompany">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.settings['widget_title_explain_type'] === '2' && widget.descriptionToggle == '1' && widget.subTitleToggle == '2' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" class="centerPositionImageCompany">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.descriptionToggle == '2' && widget.subTitleToggle == '1' && widget.mainImageToggle == '1'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" class="noCompanyImageExplain">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
        <p ng-if="widget.descriptionToggle == '2' && widget.subTitleToggle == '1' && widget.mainImageToggle == '2'" id="widgetDescription" class="details" ng-class="{notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false, notNone:widget.widget_inside_border_none === ''||widget.widget_inside_border_none === false}" class="noCompanyImageExplain">{{widget.descriptionToggle == '1' ? widget.settings['description'] : '&thinsp;'}}</p>
