  ...
  <!--
   ...
   -->
      <div id='descriptionSet' class="widgetOpener notSelect" ng-hide="widget.spHeaderLightToggle() || widget.mainImageToggle == '2' && widget.subTitleToggle == '2' && widget.descriptionToggle == '2'">
        ...
        <p ng-if="widget.descriptionToggle == '2' && widget.subTitleToggle == '2' && widget.mainImageToggle == '1'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details noCompanyImageExplain">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
        <p ng-if="widget.descriptionToggle == '2' && widget.subTitleToggle == '2' && widget.mainImageToggle == '2'" id="widgetSubTitle" ng-class="{ notNoneWidgetOutsideBorder:widget.widget_outside_border_none === ''||widget.widget_outside_border_none === false}" class="details noCompanyImageExplain">{{widget.subTitleToggle == '1' ? widget.settings['sub_title'] : '&thinsp;'}}</p>
