<script type="text/javascript">
  ...
  sincloApp.controller('SimulatorController', ['$scope', '$timeout', 'SimulatorService', function ($scope, $timeout, SimulatorService) {
    ...
    $scope.addInputEvent = function () {
      $(document).on('input paste', '#chatTalk div > li.sinclo_re.sinclo_form input.formInput', $scope.validInputText);
    };

    $scope.removeInputEvent = function () {
      $(document).off('input paste', '#chatTalk div > li.sinclo_re.sinclo_form input.formInput', $scope.validInputText);
    };
