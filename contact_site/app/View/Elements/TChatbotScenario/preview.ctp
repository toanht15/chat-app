...
<section ng-repeat="(setActionId, setItem) in setActionList" id="action{{setActionId}}_preview">
  ...
  <ul class="chatTalk details">
    ...
    <!-- ファイル送信 -->
    <div>
      <li ng-show="setItem.file.fileName && setItem.file.fileSize" class="sinclo_re chat_left details" ng-class="{notNone: widget.re_border_none === '' || widget.re_border_none === false, boxType: widget.settings['chat_message_design_type'] == 1, balloonType: widget.settings['chat_message_design_type'] == 2}"><span class="cName details">ファイルが送信されました</span><div class="sendFileContent"><div class="sendFileThumbnailArea"><img src="https://ws2.sinclo.jp/File/download?param=YTZmM2MyNWFjYmZmMWU0ODA5MGNmZjhmNDk3ZTFlY2E5NzI1MzU5NTA1OWZjNGM2YjRlNzRjYjYzMGY1NWUyMTZ4elgKEiyg66PhkylHK%2Bn%2F44I%2BeHv4F%2FRZ5BpKm3r3ChtX7YDUTYIMKmpZjh1q2Q%3D%3D" class="sendFileThumbnail" width="64" height="64"></div><div class="sendFileMetaArea"><span class="data sendFileName details">{{setItem.file.fileName}}</span><span class="data sendFileSize details">{{setItem.file.fileSize/1024|number:2}}KB</span></div></div></li>
    </div>
  </ul>
</section>
