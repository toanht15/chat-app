<div ng-if="setItem.actionType == <?= C_SCENARIO_ACTION_TEXT ?>" class="set_action_item_body action_text">
  <ul>
    <li class="styleFlexbox">
      ...
      <div>
        <resize-textarea name="message" maxlength="4000" ng-model="setItem.message" cols="48" rows="1" placeholder="メッセージを入力してください" ng-required="true" data-maxRow="10"></resize-textarea>
      </div>
    </li>
  </ul>
</div>