...
<div ng-if="setItem.actionType == <?= C_SCENARIO_ACTION_RECEIVE_FILE ?>" class="set_action_item_body action_receive_file">
  <ul>
    <li class="styleFlexbox">
      ...
      <div>
        <resize-textarea name="dropAreaMessage" class="variable-suggest system-variable-suggest" ng-model="setItem.dropAreaMessage" cols="48" rows="1" placeholder="メッセージを入力してください" ng-required="true" data-maxRow="10"></resize-textarea>
      </div>
    </li>
    <li class="styleFlexbox">
    ...
    <li class="styleFlexbox">
      ...
      <div style="display:flex; align-items: center;">
        <resize-textarea maxlength="4000" class="variable-suggest system-variable-suggest" name="errorMessage" ng-model="setItem.errorMessage" cols="48" rows="1" placeholder="メッセージを入力してください" ng-required="true" data-maxRow="10"></resize-textarea>
      </div>
    </li>
    <li>
