    ...
    <li>
      ...
      <ul class="input-one-row hearing-input-type"
        ...
        <li class='grid-container-control-variable grid-container-body itemListGroup'
          ...
          <div class='area-name'><input type="text" class="raw-variable-suggest system-variable-suggest" ng-model="item.variableName"></div>
          <div class='area-type'>
          ...
          <div class='area-message'>
            <resize-textarea maxlength="4000" ng-model="item.formula" rows="1" class="variable-suggest system-variable-suggest"
