...
<div ng-if="setItem.actionType == <?= C_SCENARIO_ACTION_SEND_FILE ?>" class="set_action_item_body action_send_file">
  <ul>
    <li class="styleFlexbox">
      ...
      <div>
        <resize-textarea maxlength="4000" name="message" class="variable-suggest" ng-model="setItem.message" cols="48" rows="1" placeholder="メッセージを入力してください" ng-required="true" data-maxRow="10"></resize-textarea>
      </div>
    </li>
    <li class="styleFlexbox">
