...
<?= $this->Form->create('MUser', array('type' => 'post', 'url' => array('controller' => 'PersonalSettings', 'action' => 'index'))); ?>
	<div class="form01">
		...
		<section>
			...
			<ul>
				<li>
					<div class="labelArea fLeft"><span><label>名前</label></span></div>
				...
				<li>
					<div class="labelArea fLeft"><span><label>表示名</label></span></div>
				...
				<li>
					<div class="labelArea fLeft"><span><label>メールアドレス</label></span></div>
