...
class CustomersController extends AppController {
    ...
    public function index() {
        $this->set('muserList', $this->MUser->find('list', [
            'fields' => 'MUser.id, MUser.display_name',
            'conditions' => ['MUser.del_flg != ' => 1],
            'recursive' => -1
        ]));
    }
        ...
        if ( isset($this->params->query['tmpCustomersId']) && isset($this->params->query['tabId']) ) {
            $params = array(
                ...
                'conditions' => array(
                    ...
                    'THistory.visitors_id' => $this->params->query['tmpCustomersId'],
