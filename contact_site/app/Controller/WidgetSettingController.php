...
class WidgetSettingController extends FileAppController
{
  ...
  public $styleSetting = [
    'common' => [
      ...
      /* カラー設定start */
      'color_setting_type','main_color','string_color','message_text_color','other_text_color','header_text_size','widget_border_color','chat_talk_border_color','header_background_color','sub_title_text_color','description_text_color', 'close_btn_color',
