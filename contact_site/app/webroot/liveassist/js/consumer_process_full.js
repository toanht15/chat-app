...
$(function(){
        ...
        createShortCode().then(function(shortcode){
            ...
            getSessionInfo(shortcode).then(function(){
                ...
                AssistSDK.startSupport({
                    ...
                    sessionToken : startResponse['token'] ? startResponse['token'] : "undefined",
    ...
    function getSessionInfo(shortcode) {
        ...
        request.open("POST", "https://sdk005.live-assist.jp/assistserver/consumer", true);
        request.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        request.send("type=create&targetServer=" + Base64.encode("https://sdk005.live-assist.jp")
            + "&originServer=" + Base64.encode(window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : "")));
        return deferred.promise();
    }
