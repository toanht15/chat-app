<?php
class AddTableTHistoryWidgetCloseCountsTHistoryWidgetMinimizeCounts extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'add_table_t_history_widget_close_counts_t_history_widget_minimize_counts';
 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				't_history_widget_close_counts' => array(
				...
				't_history_widget_minimize_counts' => array(
					'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'unsigned' => false, 'key' => 'primary'),
					'm_companies_id' => array('type' => 'integer', 'null' => true, 'default' => null, 'unsigned' => false, 'key' => 'index'),
					'year' => array('type' => 'integer', 'null' => true, 'default' => null, 'length' => 4, 'unsigned' => false),
					'month' => array('type' => 'string', 'null' => true, 'default' => null, 'length' => 2, 'collate' => 'utf8_general_ci', 'charset' => 'utf8'),
		...
		'down' => array(
			'drop_table' => array(
				't_history_widget_close_counts', 't_history_widget_minimize_counts'
			),
		),
	);
