...
<?= $this->element('MailTemplateSettings/commonScript'); ?>
...
<div id='contract_idx'>
  ...
  <div id='contract_form' class="p20x">
    <?= $this->Form->create('MailTemplateSettings', array('type' => 'post','name' => 'form', 'url' => '/MailTemplateSettings/edit/'.$id.'/'.$value)); ?>
      <div class="form01">
        <section>
          ...
          <ul class='formArea'>
            ...
            <?=$this->Form->hidden('id')?>
              <div class="button">
                ...
                <?= $this->Html->link('削除', 'javascript:void(0)', ['escape' => false, 'id' => 'searchRefine','class' => 'action_btn delete_btn','onclick' => "remoteDeleteCompany('$id','$value')"]); ?>
              </div>
            </section>
          </ul>
        </section>
